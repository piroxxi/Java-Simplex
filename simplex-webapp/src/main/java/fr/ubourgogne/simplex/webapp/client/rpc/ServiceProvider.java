...
/**
 * Classe chargée d'instancier l'ensemble des services, afin que tout le monde
 * puisse en disposer en se faisant injecter cette classe. C'est la meilleur
 * (seule?) manière d'avoir tous les services en Singleton.
 */
