...
public class GitLoader {
	private static Logger logger = LoggerFactory.getLogger(GitLoader.class);
	...
	public static String loadExternalCode(String url, String id) {
		 ...
		 */
		try {
			logger.debug("loading code from " + url + " ...");
			commande.call();
